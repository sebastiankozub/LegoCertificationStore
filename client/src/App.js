...
class App extends Component { 
  state = { storageValue: 0, web3: null, accounts: null, contract: null, responseArray: null }; 
  ...
  componentDidMount = async () => { 
    try {
      ...
      this.setState({ web3, accounts, contract: instance, responseArray: [0] }, this.runExample);
    } catch (error) {
  ...
  runExample = async () => {
    ...
    const response2 = await contract.methods.createNewCertificate("11111111","gdsfgdsfg","gdsfgdsfg","gdsfgdsfg","gdsfgdsfg","gdsfgdsfg",["gdsfgdsfg"],["gdsfgdsfg","11111111111"]).send({from:accounts[0]});
    const response3 = await contract.methods.createNewCertificate("22222222","gdsfgdsfg","gdsfgdsfg","gdsfgdsfg","gdsfgdsfg","gdsfgdsfg",["gdsfgdsfg"],["gdsf3333422222","2222222"]).send({from:accounts[0]});
    const response4 = await contract.methods.createNewCertificate("33333333","gdsfgdsfg","gdsfgdsfg","gdsfgdsfg","gdsfgdsfg","gdsfgdsfg",["gdsfgdsfg"],["gdsf3333","23333333"]).send({from:accounts[0]});
